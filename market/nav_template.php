    ...
    <nav class="gaming-nav" id="gamingNav">
        <div class="nav-container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li class="nav-item">
                    <a href="index.php" class="nav-link <?php echo $current_page == 'market/index.php' ? 'active' : ''; ?>">
                ...
                <div class="nav-user">
                    <div class="user-balance">
                        <div class="balance-item c-coin">
                            <i class="fas fa-coins"></i>
                            <span id="navCCoin"><?php echo number_format($c_coin); ?></span>
                        </div>
                        <div class="balance-item b-coin">
                            <i class="fas fa-gem"></i>
                            <span id="navBCoin"><?php echo number_format($b_coin); ?></span>
                        </div>
                    </div>
