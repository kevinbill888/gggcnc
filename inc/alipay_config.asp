...
partner         = "2088002513528723"

'安全检验码，以数字和字母组成的32位字符
key   			= "f94nmeo2zcbgfioura1qik5ogb23y3yn"

'签约支付宝账号或卖家支付宝帐户
seller_email    = "zijingkj@126.com"

'交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
notify_url      = "http://www.165sf.com/pay/notify_url.asp"

'付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
return_url      = "http://www.165sf.com/pay/return_url.asp"
